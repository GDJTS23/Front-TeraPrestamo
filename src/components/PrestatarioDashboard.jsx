  ...
  const Infrome = async () => {
    try {
      const headers = { key: user.token }
       ...
       const maxLinesPerPage = Math.floor((pageHeight - margin) / lineHeight);
          ...
          <Grid item xs={12} sm={8} md={9} >
            <List sx={{ml: 30}}>
              ...
              <ListItemButton>
                ...
                <Link sx={{ cursor: 'pointer' }} color="primary" onClick={() => router.push('/ofertaPresta')}>
                    VER OFERTAS DE PRÉSTAMOS
                  </Link>
              </ListItemButton>
              ...
              <ListItemButton>
                ...
                <Link sx={{ cursor: 'pointer' }} color="primary" onClick={() => router.push('/operaLista')}>
